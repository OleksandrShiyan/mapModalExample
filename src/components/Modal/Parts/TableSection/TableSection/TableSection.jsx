...
const TableSection = () => {
    ...
    const data = db.map((el, index) => (
        <div className={styled.contentUnit} key={index}>
            <span className={`${styled.table1} ${styled.tableCenter}`}>{el.time}</span>
            <span className={`${styled.table2} ${styled.tableCenter}`}>{el.field}</span>
            <span className={`${styled.table3} ${styled.tableCenter}`}>{el.fieldUnit}</span>
            <span className={`${styled.table4} ${styled.tableCenter}`}>{el.activ}</span>
            <span className={`${styled.table5} ${styled.tableCenter}`}>{el.cat}</span>
            <span className={`${styled.table6} ${styled.tableCenter}`}>{el.sub}</span>
            <span className={`${styled.table7} ${styled.tableCenter}`}>{el.crea}</span>
        ...
        <div className={styled.tableSelectionWrapper}>
            <div className={styled.header}>
                ...
                <div className={styled.headerRight}>
                    ...
                    <img className={`${styled.marginRight} ${styled.marginLeft}`} src={TableRight_2} alt="2"/>
                </div>
            </div>
